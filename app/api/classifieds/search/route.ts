...
export async function GET(request: NextRequest) {
  try {
    ...
    const orderField = params.sort === 'price_low' ? 'price' : params.sort === 'price_high' ? 'price' : 'created_at'
    const orderAsc = params.sort === 'price_low'
    ...
    console.error('Classifieds search error:', error)
